...
//function for modals in portfolio Section
function openModal() {
...
function showSlidesPortfolio(n) {
  ...
  for (i = 0; i < dots.length; i++) {
      dots[i].className = dots[i].className.replace(" activePortfolio", "");
  }
  slides[slideIndexPortfolio-1].style.display = "block";
  dots[slideIndexPortfolio-1].className += " activePortfolio";
  captionText.innerHTML = dots[slideIndexPortfolio-1].alt;
}
